...
describe('AI Providers', function() {
	...
	describe('Bedrock Provider', function() {
		it('should instantiate correctly', async function() {
			const { BedrockAIProvider } = await import('../../src/ai-providers/index.js');
	...
	describe('Azure Provider', function() {
		...
		it('should require both API key and base URL', async function() {
			...
			// Should throw for missing API key
			expect(() => provider.validateAuth({})).to.throw('Azure API key is required');
			
			// Should throw for missing base URL
			expect(() => provider.validateAuth({ apiKey: 'test' })).to.throw('Azure endpoint URL is required');
		});
	});

	describe('Google Vertex Provider', function() {
		it('should instantiate correctly', async function() {
			const { VertexAIProvider } = await import('../../src/ai-providers/index.js');
		...
		it('should require project ID and location', async function() {
			...
			expect(() => provider.validateAuth({ apiKey: 'test' })).to.throw('project ID is required');
			
			// Should throw for missing location
			expect(() => provider.validateAuth({ apiKey: 'test', projectId: 'test' })).to.throw('location is required');
		});
	});

	describe('OpenAI Provider', function() {
		it('should instantiate correctly', async function() {
			const { OpenAIProvider } = await import('../../src/ai-providers/index.js');
	...
	describe('Google Provider', function() {
		it('should instantiate correctly', async function() {
			const { GoogleAIProvider } = await import('../../src/ai-providers/index.js');
	...
	describe('Perplexity Provider', function() {
		it('should instantiate correctly', async function() {
			const { PerplexityAIProvider } = await import('../../src/ai-providers/index.js');
	...
	describe('OpenRouter Provider', function() {
		it('should instantiate correctly', async function() {
			const { OpenRouterAIProvider } = await import('../../src/ai-providers/index.js');
	...
	describe('Ollama Provider', function() {
		it('should instantiate correctly', async function() {
			const { OllamaAIProvider } = await import('../../src/ai-providers/index.js');
