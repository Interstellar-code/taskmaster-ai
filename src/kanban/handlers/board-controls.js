...
export class BoardControlsHandler {
    ...
    toggleFilter() {
        ...
        return {
            ...
            message: this.isFilterMode ? 'Filter mode enabled' : 'Filter mode disabled'
        };
    }
    ...
    displayCurrentFilters() {
        ...
        if (this.filters.hasSubtasks !== null) {
            activeFilters.push(`Subtasks: ${this.filters.hasSubtasks ? 'Yes' : 'No'}`);
        }
        if (this.filters.hasDependencies !== null) {
            activeFilters.push(`Dependencies: ${this.filters.hasDependencies ? 'Yes' : 'No'}`);
        }
    ...
    setSearchQuery(query) {
        ...
        return {
            ...
            message: this.searchQuery ? `Searching for: "${this.searchQuery}"` : 'Search cleared'
        };
    }
    ...
    getBoardState() {
        return {
            ...
            originalTaskCount: this.originalTasks.length || this.kanbanBoard.tasks.length
        };
    }
