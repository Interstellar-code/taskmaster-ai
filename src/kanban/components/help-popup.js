...
export class HelpPopup {
    ...
    generateHelpContent() {
        ...
        // Title
        this.contentLines.push(chalk.cyan.bold('📚 TASKMASTER KANBAN BOARD - HELP & CONTROLS'));
        ...
        this.contentLines.push(chalk.gray('   ↑ ↓     : Move between tasks within a column'));
        this.contentLines.push(chalk.gray('   Tab     : Cycle focus between board areas'));
        this.contentLines.push('');
        ...
        this.contentLines.push('');
        this.contentLines.push(chalk.gray('   1       : Move selected task to Pending'));
        this.contentLines.push(chalk.gray('   2       : Move selected task to In Progress'));
        this.contentLines.push(chalk.gray('   3       : Move selected task to Done'));
        this.contentLines.push('');
        
        // Task operations
        this.contentLines.push(chalk.white.bold('📋 TASK OPERATIONS:'));
        this.contentLines.push('');
        this.contentLines.push(chalk.gray('   V       : View task details (large popup)'));
        ...
        this.contentLines.push('');
        this.contentLines.push(chalk.gray('   R       : Refresh board from tasks.json'));
        ...
        this.contentLines.push(chalk.gray('   🔴 🟡 🟢 : Task priority (High, Medium, Low)'));
        this.contentLines.push(chalk.gray('   D:X     : Dependencies count'));
        this.contentLines.push(chalk.gray('   Sub:X   : Subtasks count'));
        this.contentLines.push(chalk.gray('   ↑↓      : Scroll indicators in columns'));
        this.contentLines.push('');
        
        // Tips
        this.contentLines.push(chalk.white.bold('💡 TIPS:'));
        this.contentLines.push('');
        this.contentLines.push(chalk.gray('   • Use V to view detailed task information'));
        this.contentLines.push(chalk.gray('   • Column headers show scroll position (e.g., "1-14/28")'));
        this.contentLines.push(chalk.gray('   • Selected tasks have blue highlighting'));
        this.contentLines.push(chalk.gray('   • Status bar shows current column and task counts'));
        this.contentLines.push('');
    }
