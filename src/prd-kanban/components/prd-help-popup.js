...
export class PRDHelpPopup {
	...
	generateHelpContent() {
		...
		this.contentLines.push(
			chalk.cyan.bold('📚 PRD KANBAN BOARD - HELP & CONTROLS')
		);
		this.contentLines.push('');
		...
		this.contentLines.push(
			chalk.gray('   ↑ ↓     : Move between PRDs within a column')
		);
		this.contentLines.push('');
		...
		this.contentLines.push('');
		this.contentLines.push(
			chalk.gray('   1       : Move selected PRD to Pending')
		);
		this.contentLines.push(
			chalk.gray('   2       : Move selected PRD to In Progress')
		);
		this.contentLines.push(
			chalk.gray('   3       : Move selected PRD to Done')
		);
		this.contentLines.push('');
		...
		this.contentLines.push('');
		this.contentLines.push(
			chalk.gray('   V       : View PRD details (large popup)')
		);
		...
		this.contentLines.push('');
		this.contentLines.push(
			chalk.gray('   R       : Refresh board from prds.json')
		);
		...
		this.contentLines.push(
			chalk.gray('   ● ◆     : Priority and complexity indicators')
		);
		...
		this.contentLines.push('');
		this.contentLines.push(
			chalk.gray('   • Use V to view detailed PRD information')
		);
		this.contentLines.push(chalk.gray('   • Column headers show PRD counts'));
		this.contentLines.push(
			chalk.gray('   • Selected PRDs have blue highlighting')
		);
		this.contentLines.push(
			chalk.gray('   • Status bar shows current column and PRD counts')
		);
		this.contentLines.push('');
	}
